...
public static class MovementPrediction
{
  ...
  public static Vector2 PredictTargetMovement(Transform transform, Transform target, float projectileSpeed)
  {
    ...
    var (positiveAngle, negativeAngle) = GetPredictionAngles(transform, target, projectileSpeed);
  ...
  static (float, float) GetPredictionAngles(Transform transform, Transform target, float projectileSpeed)
  {
    ...
    float velocityFactor = (xDistance * vy - yDistance * vx) / projectileSpeed;
